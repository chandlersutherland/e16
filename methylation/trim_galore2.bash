...
trim_input=$base/$sample/bs_fastq_files
trim_output=$trim_input/trimmed2

mkdir -p $trim_output
cd $trim_input

#run trim galore in default, paired end mode 
FILES=$(find . -type f -name '*_1.fastq' -print)
ACCESSIONS=$(basename -a -s _1.fastq $FILES)
