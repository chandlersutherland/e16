#!/bin/bash
#SBATCH --job-name=fastq_download.oh43
...
time fasterq-dump --threads $SLURM_NTASKS -O $rna_output -t $SCRATCH_DIR -p SRR13434394
echo "SRR13434394 rna for sample $sample complete"
